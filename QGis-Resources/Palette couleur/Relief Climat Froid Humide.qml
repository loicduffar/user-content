    ...
    <rasterrenderer classificationMax="6000" opacity="1" alphaBand="-1" type="singlebandpseudocolor" band="1" classificationMin="-400">
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" classificationMode="1">
          ...
          <item value="-400" label="-400" alpha="255" color="#70938d"/>
          <item value="0" label="0" alpha="255" color="#789f98"/>
          <item value="50" label="50" alpha="255" color="#82a59f"/>
          <item value="200" label="200" alpha="255" color="#91b1ab"/>
          <item value="600" label="600" alpha="255" color="#b4c0b4"/>
